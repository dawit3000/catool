...
#' Division names are mapped to associated subject codes, and only those subjects are retained.
#'
#' @param division_name A character string naming the academic division (must match a known value).
